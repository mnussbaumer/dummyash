...
config :dummyash, DummyashWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: DummyashWeb.ErrorHTML, json: DummyashWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Dummyash.PubSub,
  live_view: [signing_salt: "zQ1Kug9G"]
...
config :dummyash, Dummyash.Mailer, adapter: Swoosh.Adapters.Local
